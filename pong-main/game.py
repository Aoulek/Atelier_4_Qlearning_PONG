...
class Game:
    ...
    def __init__(self, player_type):
        ...
        # Initialisation de l'agent d'apprentissage par renforcement
        ...
        # Définition de la vitesse de la balle et des joueurs
    ...
    def ball_animation(self):
        ...
        # Rebondissement de la balle sur les joueurs
        if self.ball.colliderect(self.player) or self.ball.colliderect(self.opponent):
            self.ball_speed_x *= -1

    # --- Animation pour le joueur humain --- #
    def animation_human(self):
        # Déplacement de la barre du joueur humain
